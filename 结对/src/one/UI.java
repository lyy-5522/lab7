...
public class UI {
	...
	/*
	 * //线程 class time extends Thread{ public void run() { for(int i=1;i>0;i++) {
	 * checkerboard.Transfer();
	 * Draw_color(checkerboard.GetRow(),checkerboard.GetColumn()); try {
	 * this.sleep(1000); } catch (InterruptedException e) { e.printStackTrace(); } }
	 * } }
	 */
