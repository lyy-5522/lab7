...
public class UI {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100,(column1+1)*50,(row1+2)*50);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		frame.getContentPane().setSize(column1*50,(row1+1)*50);//棋盘长宽：column*50,row*50
		frame.getContentPane().setBackground(Color.white);
		
		JPanel panel = new JPanel();
		panel.setBounds(15, 0, frame.getContentPane().getWidth(), row1*50);
		frame.getContentPane().add(panel);
		panel.setLayout(new GridLayout(row1,column1,0,0));
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(15, row1*50, frame.getContentPane().getWidth(), 50);
